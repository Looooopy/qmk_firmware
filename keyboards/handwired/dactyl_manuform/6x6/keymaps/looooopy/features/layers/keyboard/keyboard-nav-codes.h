...
// Left Control, Shift and Alt when held otherwise tap key code
#define MEH_SPC MEH_T(KC_SPC)
#define MEH_BSPC MEH_T(KC_BSPC)
#define MEH_ENT MEH_T(KC_ENT)

// Left Control, Shift, Alt and GUI when held otherwise tap key code
#define HYP_SPC HYPR_T(KC_SPC)
#define HYP_BSPC HYPR_T(KC_BSPC)
#define HYP_ENT HYPR_T(KC_ENT)

#define OSM_HYPE OSM(MOD_HYPR)
#define OSM_MEH  OSM(MOD_MEH)
#define OSM_LGUI OSM(MOD_LGUI)

// Switch layer
#define QWERTY  TO(_QWERTY)
#define DWORAK  TO(_DWORAK)
#define COLEMAK TO(_COLEMAK)

// Momentary switch while pressed
#define MQWERTY  MO(_QWERTY)
#define MDWORAK  MO(_DWORAK)
#define MCOLEMAK MO(_COLEMAK)

// Switch Default layer
#define DQWERTY DF(_QWERTY)
#define DDWORAK DF(_DWORAK)
#define DCOLMAK DF(_COLMAK)
