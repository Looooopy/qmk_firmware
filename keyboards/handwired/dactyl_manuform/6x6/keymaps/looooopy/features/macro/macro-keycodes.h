...
#define WIN_OS_WAIT 200             // USB pulling 200 micro seconds
...
#define WIN_COPY                    SEND_STRING(SS_LCTL("c"));
#define WIN_PASTE                   SEND_STRING(SS_LCTL("v"));
...
#define WIN_START_UPLAY             SEND_STRING(SS_TAP(X_LGUI) SS_DELAY(WIN_OS_WAIT) "ubisoft connect"          SS_DELAY(WIN_OS_WAIT) SS_TAP(X_ENT))
...
// MAC OS
// May need to tweak on diffrent systems if apps do not start
#define MAC_OS_WAIT 200             // USB pulling 200 micro seconds
...
#define MAC_LOCK_SCREEN             SEND_STRING(SS_LGUI(SS_LCTL(SS_TAP(X_Q))) "()")
...
#define MAC_SPOTL_UPLAY             SEND_STRING(SS_LGUI(" ") SS_DELAY(MAC_OS_WAIT) "ubisoft connect"            SS_DELAY(MAC_OS_WAIT) SS_TAP(X_ENT))
...
#define MAC_START_TERMINAL          SEND_STRING(SS_TAP(X_LGUI) SS_DELAY(MAC_OS_WAIT) "alacritty"                SS_DELAY(MAC_OS_WAIT) SS_TAP(X_ENT))
