...
ifeq ($(strip $(MCU)), STM32F411)
    ...
    MUSIC_ENABLE = no
    OS_DETECTION_ENABLE = yes		# USB Comminication to get which os in use
...
SRC += features/settings/settings.c \
       features/rgblight/rgblight.c

ifeq ($(strip $(WPM_ENABLE)), yes)
   OPT_DEFS += -DWPM_ENABLE
   SRC += features/words_per_minute/wpm.c \
          features/split_transport/wpm_high_score.c
endif
